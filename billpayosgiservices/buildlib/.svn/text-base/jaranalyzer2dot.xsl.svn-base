...
<!--
  ...
  The jar files show up as rectangles with the jar file name
  and the number of packages.  Arrows point to other jar files
  the jar depends on.  The rectangle is colored blue, but
  it turns to darker shades of red the further the jar is
  from the 'main line'.

  Gleaned from JDepend stylesheet of the same function, 
